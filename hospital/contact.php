   ...
   <header>
    ...
    <section id="contact-form" class="py-3">
        <div class="container">
            ...
            <p>   لطفا فیلد های زیر را پر کنید <?php echo $_SESSION['username'] ?></p>
            <form action="submitReserve.php" method="post">
                <div class="form-group">
                    ...
                    <select name="khadamat" required>
                        ...
                        <option value="ortodensi"  name="ortodensi" id="ortodensi">ارتودنسی</option>
                        <option value="impelant"   name="impelant"  id="impelant">ایمپلنت</option>
                        <option value="asabkeshi"  name="asabkeshi" id="asabkeshi">عصب کشی</option>
                        <option value="porkardan"  name="porkardan" id="porkardan">پر کردن</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="message" id="message" style="direction:rtl" placeholder="اگر بیماری خاصی دارید یا نکته خاصی هست اعلام بفرمایید"></textarea>
                </div>
